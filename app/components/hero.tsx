        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left px-6 sm:px-10 h-full">
          ...
          >
            <Image
              ...
              width={600}
              height={80}
              className="object-contain w-full max-w-[80vw] sm:max-w-lg md:max-w-md"
              priority
            />
          </motion.div>

          <motion.h1
            className=" grid sm:grid-cols-1 text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-neutral-800"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="absolute bottom-6 left-1/2 transform -translate-x-1/2 md:left-6 md:translate-x-0 flex flex-col md:flex-row gap-4 items-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid sm:grid-cols-1 md:flex md:flex-[1.2] h-[50%] md:h-full">
          ...
          >
            <Image
              ...
              fill
              className=" grid sm:grid-cols-1 sm:w-16 aspect-auto object-cover object-bottom-right"
              priority
            />
          </motion.div>
          ...
          {/* Our Groups Section */}
          <motion.div
            className="flex flex-col justify-center items-center bg-sky-400 text-white px-4 h-full pt-10 md:pt-20 md:flex-1"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
